...
public class DepositarFrame extends JFrame {
    ...
    public DepositarFrame(){
        ...
        lbTaxaRendimento.setToolTipText("Digite o valor a ser depositado.");
        add(lbTaxaRendimento);
        
        Dimension sizeTaxa = lbTaxaRendimento.getPreferredSize();
        lbTaxaRendimento.setBounds(10, 35, sizeTaxa.width, sizeTaxa.height);
        ...
        txtTaxaRendimento.setBounds(60, 35, sizeTxtTaxaRendimento.width, sizeTxtTaxaRendimento.height);
        ...
        btnCriar = new JButton("Depositar");
        add(btnCriar);
        
        Dimension sizeBtnLogin = btnCriar.getPreferredSize();
        btnCriar.setBounds(50, 60, sizeBtnLogin.width, sizeBtnLogin.height);
    ...
    private class ButtonHandler implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
           ...
           String msg;
            try {
                msg = cf.deposita(Integer.parseInt(txtNome.getText()),Double.parseDouble(txtTaxaRendimento.getText()));
            } catch (Exception ex) {
                msg = "Numero Invalido! Digite novamente.";
                //Logger.getLogger(DepositarFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
