 ...
 * @author 17164260
 */
public class CadastraContaEspecialFrame extends JFrame {
    ...
    public CadastraContaEspecialFrame(){
        ...
        lbTaxaRendimento = new JLabel("Limite: ");
        lbTaxaRendimento.setToolTipText("Digite um limite.");
    ...
    private class ButtonHandler implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
           ...
           String msg;
            try {
                msg = cf.novaContaEspecial(txtNome.getText(), Integer.parseInt(txtNumero.getText()), Double.parseDouble(txtTaxaRendimento.getText()));
            } catch (Exception ex) {
                msg = "Numero Invalido! Digite novamente.";
                //Logger.getLogger(CadastraContaEspecialFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
